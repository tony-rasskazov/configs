...
QtPlugin {
    ...
    frameworksDebug: ["Foundation", "AVFoundation", "CoreAudio", "AudioToolbox", "MobileCoreServices", "UIKit", "CoreFoundation", "Security", "SystemConfiguration", "CoreText", "CoreGraphics", "OpenGLES"]
    frameworksRelease: ["Foundation", "AVFoundation", "CoreAudio", "AudioToolbox", "MobileCoreServices", "UIKit", "CoreFoundation", "Security", "SystemConfiguration", "CoreText", "CoreGraphics", "OpenGLES"]
    frameworkPathsDebug: []
    frameworkPathsRelease: []
    libNameForLinkerDebug: "qtaudio_coreaudio_debug"
    libNameForLinkerRelease: "qtaudio_coreaudio"
    libFilePathDebug: "/Users/tony/Qt/5.7/ios/plugins/audio/libqtaudio_coreaudio_debug.a"
    libFilePathRelease: "/Users/tony/Qt/5.7/ios/plugins/audio/libqtaudio_coreaudio.a"
