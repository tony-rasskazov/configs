...
Module {
    ...
    property stringList dynamicLibsRelease: ["EGL", "GLESv2", "GLES_CM", "IMGegl", "srv_um", "usc", "pthread"]
    ...
    property string libFilePathRelease: "/opt/compiler_platform/compiled/lib/libQt5Core.so.5.3.2"
    property string libFilePath: qtBuildVariant === "debug"
                                      ? libFilePathDebug : libFilePathRelease

    coreLibPaths: ["/home/user/work/12_trim/codeclear/external/qt-everywhere-opensource-src-5.3.2/qtbase/mkspecs/linux-TIarmv7-sgx-g++/../../../../Graphics_SDK_5_01_01_02/gfx_dbg_es8.x/"]
    ...
    cpp.includePaths: {
        var paths = ["/opt/compiler_platform/compiled/include", "/opt/compiler_platform/compiled/include/QtCore"];
